...
export const generateUpgradesToValue.prompt = `You'll receive a value (target), and a bunch of other values (candidates). Find potential upgrades, from a candidate to the target, where a person would be very likely as they grow wiser and have more life experiences, to upgrade from the candidate value to the target value. Importantly, the person should consider this a change for the better and it should not be a value-shift but a value-deepening.
